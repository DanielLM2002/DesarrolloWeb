   ...
   <div class="container-fluid p-4">
     ...
     <template v-else>
       <div class="row">
         ...
         <div class="col-2 fw-bold text-center">Done</div>
       </div>
     ...
     <div class="row py-2">
       ...
       <div class="col-2">
         <button class="btn btn-primary w-100" v-on:click="addNewTodo">Add</button>
       </div>
     </div>
     <div class="row bg-secondary py-2 mt-2 text-white">
       <div class="col text-center">
         <input type="checkbox" v-model="hideCompleted" class="form-check-input mx-2 my-2" />
         <label class="form-check-label fw-bold my-1">
